...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RU_EmployeeMetrics]') AND type in (N'U'))
DROP TABLE [dbo].[RU_EmployeeMetrics]
GO
...
CREATE TABLE [dbo].[RU_EmployeeMetrics](
	   [LocationNo] [char](5) NULL --All location numbers typically stored as CHAR(5)
      ,[Employee_Login] [varchar](20) NULL --I'm unsure of the standard maximum for employee logins, but I've never observed one over 20 characters long.
