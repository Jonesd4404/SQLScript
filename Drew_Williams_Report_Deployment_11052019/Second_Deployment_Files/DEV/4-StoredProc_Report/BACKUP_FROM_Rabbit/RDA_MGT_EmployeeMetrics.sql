...
/****** Object:  StoredProcedure [dbo].[RDA_MGT_EmployeeMetrics]    Script Date: 11/6/2019 1:26:53 PM ******/
SET ANSI_NULLS ON
GO
...
-- Changes:
--	7/22/19 - Added missed ISNULL() statements, which caused errors for one location. Ticket #17019.
-- =============================================
