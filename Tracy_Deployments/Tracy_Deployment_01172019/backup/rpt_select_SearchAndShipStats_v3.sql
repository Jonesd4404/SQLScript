...
/****** Object:  StoredProcedure [dbo].[rpt_select_SearchAndShipStats_v3]    Script Date: 1/17/2019 8:25:45 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[rpt_select_SearchAndShipStats_v3]
(
--DECLARE
     @startdate DATETIME --= '4/1/18'
	,@enddate DATETIME --= '4/17/18'
