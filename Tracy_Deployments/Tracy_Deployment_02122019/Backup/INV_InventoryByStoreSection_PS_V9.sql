...
/****** Object:  StoredProcedure [dbo].[INV_InventoryByStoreSection_PS_V9]    Script Date: 2/12/2019 1:44:51 PM ******/
SET ANSI_NULLS OFF
GO
...
CREATE PROCEDURE [dbo].[INV_InventoryByStoreSection_PS_V9]
	--DECLARE
	@Inventory_ID1 INT
	--= 1011361 --Jun 2015
	--=549 --Jan 2018
...
Update: 5/17/18 Tracy Dennis Changed to use the same time period for used and new.  Also redid by binding instead of product type. Changed the New to use 
        ...
        2/7/2019 Tracy Dennis Removed PTypeGroup since we moved to binding it creates confusion. Moved Binding Name above Ptclass in grouping. #12268
*************************************************************************************************************************************************************/
