...
/****** Object:  StoredProcedure [dbo].[INV_InventoryByBinding]    Script Date: 05/23/2018 11:16:54 ******/
SET ANSI_NULLS OFF
GO
...
Create PROCEDURE [dbo].[INV_InventoryByBinding]
--DECLARE 
@Inventory_ID1 INT
	--=1011030  --Jan2015
	--= 549 --Jan 2018
...
INTO #INV1
FROM 
ReportsData..ShelfScan_Inventory_Bindings b   
--ReportsData..ProductTypes Rpt
left JOIN HPB_INV..Scheduled_Inventory_Reporting i 
--ReportsData..ShelfScan_Inventory_Bindings b
 ON i.BindingCode = b.BindingCode
