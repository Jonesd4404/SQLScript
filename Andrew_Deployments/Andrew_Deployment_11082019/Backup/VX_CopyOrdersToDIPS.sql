...
/****** Object:  StoredProcedure [dbo].[VX_CopyOrdersToDIPS]    Script Date: 11/8/2019 11:42:38 AM ******/
SET ANSI_NULLS ON
GO
	...
	WHILE @loop > 0
		BEGIN
			...
			ELSE IF @vendor <> 'IDB&TDISTR'
				BEGIN
					-- For in house 
						-- TO FIX:   CHECK FOR IN HOUSE  AND IF SO CREATE A FAKE SHIPID

					-- For non In-house orders do this...
